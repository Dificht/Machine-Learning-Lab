...
from notebooks.dsets import Ct, LunaDataset

clim=(-1000.0, 300)

# Собираем список первых 100 позитивных кандидатов
...
# Создаём датасет для конкретной серии, ищем индексы позитивных 
# кандидатов, визуализируем результат
def showCandidate(series_uid, batch_ndx=None, **kwargs):
    ...
    plt.tight_layout()
    plt.pause(0.1)
    plt.savefig("candidate_debug.png")